          ...
          if(province_listID) {
              $.ajax({
                  ...
                  success:function(data) {                      
                      $('select[name="bill_district"]').empty();
                      $.each(data, function(key, data) {
                          $('select[name="bill_district"]').append('<option value="'+ data['district_id'] +'">'+ data['district_name'] +'</option>');
                      });
                  }
              });
          }else{
                       ...
                       if($('#district').val()) {
                          ...
                          if(district_listID) {
                              $.ajax({
                                  ...
                                  dataType: "json",
                                  success:function(data) {                      
                                      $('select[name="bill_ward"]').empty();
                                      $.each(data, function(key, data) {
                                          $('select[name="bill_ward"]').append('<option value="'+ data['ward_id'] +'">'+ data['ward_name'] +'</option>');
                                      });
        ...
        console.log('change');
          ...
          if(province_listID) {
              $.ajax({
                  ...
                  dataType: "json",
                  success:function(data) {                      
                      $('select[name="bill_district_people"]').empty();
                      $.each(data, function(key, data) {
                          $('select[name="bill_district_people"]').append('<option value="'+ data['district_id'] +'">'+ data['district_name'] +'</option>');
                      });
                  }
              });
          }else{
